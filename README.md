...
[`Google Colab File`](https://colab.research.google.com/drive/1HzMbLuOk4PNgGZ-D4fUhilogEUtZFmSR?usp=sharing)

## Object Detection and Tracking (ID + Trails)  using YOLOv8 on Custom Data
## Google Colab File Link (A Single Click Solution)
[`Google Colab File`](https://colab.research.google.com/drive/14JI2zLn3akGRLCfloYgrPV6NMS1gjclq?usp=sharing)

## YOLOv8 Segmentation with DeepSORT Object Tracking

[`Github Repo Link`](https://github.com/FarooqueAhmeed/YOLOv8-DeepSORT-Object-Tracking.git)

## Steps to run Code

- Clone the repository
```
git clone https://github.com/FarooqueAhmeed/YOLOv8-DeepSORT-Object-Tracking.git
```
